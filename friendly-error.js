...
// "Upload failed: <this>". Kept out of main.js so it can be tested on its own.
//
...
function friendlyFetchError(e) {
  ...
  return networkFailure
    ? `Could not reach PicPub (${detail}) — check your connection, and if you use a firewall, VPN or proxy, allow Lit Chat to connect to picpub.art`
    : detail;
}
